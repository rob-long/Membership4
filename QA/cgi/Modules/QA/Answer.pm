...
sub response {
    my $this = shift;
    return $this->loaded() ? new Modules::QA::Response(id=>$this->getdata("qa_reponse_id")) : undef;
}

sub question {
    my $this = shift;
    return $this->loaded() ? new Modules::QA::Question(id=>$this->getdata("qa_question_id")) : undef;
}
